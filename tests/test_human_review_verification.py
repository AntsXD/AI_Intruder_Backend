...
def test_verify_only_human_review_events(client, webhook_headers, make_auth_headers) -> None:
    ...
    intruder_event = client.post(
        "/api/v1/webhooks/intruder",
        json={"property_id": pid, "similarity_score": 40.0, "snapshot_base64": "ZmFrZQ==", "note": "intruder"},
        headers=webhook_headers,
    )
...
def test_verify_confirmed_intruder_triggers_telegram_task(client, webhook_headers, make_auth_headers, monkeypatch) -> None:
